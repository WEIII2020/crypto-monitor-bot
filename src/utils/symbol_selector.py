...
class SymbolSelector:
    ...
    def __init__(self):
        ...
        # Selection criteria (优化：扩大到150-200个币种)
        self.min_volume_usd = 1_000_000      # $1M minimum daily volume
        self.max_volume_usd = 500_000_000    # $500M maximum (包含主流币)
    ...
    async def get_monitoring_list(self, max_symbols: int = 200) -> List[str]:
        """
        Get flat list of symbols for monitoring

        Args:
            max_symbols: Maximum number of symbols to monitor (default 200)
        ...
        tier3_count = remaining  # 使用所有剩余空间
